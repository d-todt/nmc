...
def run_experiment():
    ...
    traj, _ = experiment.prepare_experiment(
        jube_parameter=jube_params, multiprocessing=False, name=f"HPCBenchmark_CrossEntropy")
    ...
    ## Cross Entropy Optimizer
        case "ce":
            optimizer_seed = 1234
            optimizer_parameters = CrossEntropyParameters(pop_size=4, rho=0.9, smoothing=0.0, temp_decay=0, n_iteration=2,
